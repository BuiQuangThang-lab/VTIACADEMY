...
public class Data {
	...
	public static void main(String[] args) {
		...
		// Question5:
		Position temp[] = {position1,position2,position3};
		
		Account account7 = new Account();
		account7.id = 6;
		account7.email = "Mai.mc@gmail.com";
		account7.userName = "MacNga";
		account7.fullName = "Trịnh Ngọc Mai";
		account7.cretateDate = new Date("2016/08/06");
		...
		System.out.println(account7.position.name);
		...
		if(j==1) {
			...
			Scanner maSv = new Scanner(System.in);
			int id = maSv.nextInt();
			account9.id = id;
			Scanner hoVaTen = new Scanner(System.in);
			System.out.println("hoVaTen: ");
			String name = hoVaTen.next();
			account9.fullName = name;
		}
		if(j==2) {
			Department department5 = new Department();
			System.out.println("tạo Department");
			System.out.println("id: ");
			Scanner maPhong = new Scanner(System.in);
			int id = maPhong.nextInt();
			department5.id = id;
			Scanner hoVaTen = new Scanner(System.in);
			System.out.println("hoVaTen: ");
			String name = hoVaTen.next();
			department5.name = name;
		...
		String User[] = {account1.userName,account2.userName,account3.userName};
		for(int a = 0; a < User.length; i++) {
			System.out.println(User[a]);
		}
		//B2:
		
		System.out.println("Hãy nhập User của account: ");
		...
		String group[] = {group1.name,group2.name,group3.name};
		...
		System.out.println("Hãy nhập User của account: ");
		Scanner nhom = new Scanner(System.in);
		System.out.println("hoVaTen: ");
		String groups = nhom.next();
